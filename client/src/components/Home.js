...
class Home extends React.Component {
	...
	componentDidMount(){
		...
		window.setInterval(() => {
			console.log(11);
			let el = document.querySelector('#root > div > div > div.master-layout > div.master-layout__header > div > label:nth-child(2) > div > div > a')
			if (el) el.onclick = this.update;
		},300) // interval because loadToolKit needs to be ran for the element to exist
		this.update();
	}
	      ...
	      <div className="master-layout">
	        ...
	        <div className="master-layout__hero">
	          <div className="home__table">
	            ...
	            {
	            	!this.state.today_jobs ? <center><img src="http://localhost:3000/assets/toolkit/images/loading_blue.gif"/></center>
	            	: 
	            	(
	            ...
	            <h4 className="home__table-title">This week</h4>	            	
					{ !this.state.week_jobs ? <center><img src="http://localhost:3000/assets/toolkit/images/loading_blue.gif"/></center>
	            	: 
	            	(
	            		this.state.week_jobs.map(job => (
			              <div className="job-listing-table__list home-table no-border">
			                ...
			                <div className="job-listing-table__time">
				                {
				                	job.status === "FEATURED" 
				                	? <span class="new blue"><img src="/assets/toolkit/images/blue-star.svg" alt=""/>Featured</span>
				                	: <span class="new "><img src="/assets/toolkit/images/blue-star.svg" alt=""/>New</span>
				                }
			                  <h5><img src="/assets/toolkit/images/gray-placeholder.svg" alt />{job.location}</h5>
			                </div>
		              	</div>
